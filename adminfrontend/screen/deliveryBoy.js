        ...
        <View >
            <ScrollView>
                <View style={{ flexDirection: "row",justifyContent:'space-between',paddingRight:10 }}>
                    <Icons name="arrow-back" onPress={()=>navigation.navigate("Dashboard")} color="#FDC913" size={35} style={{ marginLeft: 10,marginTop:10 }}></Icons>
                    <Text style={styles.boy}>Delivery Boy</Text>
                    <TouchableOpacity style={{paddingTop:10}} onPress={() => navigation.navigate("deliveryRegScreen")}>
                        <Text style={{
                ...
                <View style={styles.search}>
                    <TextInput style={{fontFamily:'OpenSansRegular',width:120}} placeholder="Search ID"></TextInput>
