    ...
    <View >
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={{ flexDirection: "row", paddingBottom: 10 }}>
          <Icons name="arrow-back" color="#FDC913" onPress={() => navigation.navigate("deliveryBoy")} size={30} style={{ marginLeft: 10, marginTop:10 }}></Icons>
        ...
        <View style={{ flexDirection: 'row' }}>
          <Text style={{
            marginLeft: 100, color: "#696969", 
            fontFamily: "OpenSansRegular", marginTop: 15
