    ...
    <View >
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={{ flexDirection: "row",paddingBottom:10 }}>
          <Icons name="arrow-back" color="#FDC913" onPress={()=>navigation.navigate("deliveryBoy")} size={35} style={{ marginLeft: 10, marginTop:10 }}></Icons>
        ...
        <View style={styles.view3}>
          ...
          <View style={{ flexDirection: 'row', marginLeft: 30 }}>
            ...
            <RadioButton
              ...
              color="#696969"
            />
            <View style={{borderRadius:100, borderColor:'#696969'}}></View>
